        ...
        <div className={styles.registration__page}>
            ...
            <div style={{position: 'relative'}}className={styles['registration__page-wrapper']}>
                ...
                className={styles['form']}>
                    ...
                    {
                        isDataValid ? <Button type='submit' style={{backgroundColor: "black", padding: "10px 20px", borderColor: "#000", fontSize: 18, height: 50}}>Зарегистрироваться</Button>
                        : <Button disabled type='submit' style={{backgroundColor: "black", padding: "10px 20px", borderColor: "#000", fontSize: 18, height: 50}}>Зарегистрироваться</Button>
                    }
